...
import solar from '../../translations/solar.json';
import magelan from '../../translations/magelan.json';
...
export class I18nService {
  ...
  constructor(private readonly _translateService: TranslateService) {
    ...
    _translateService.setTranslation('solar', solar);
    _translateService.setTranslation('magelan', magelan);
  }
